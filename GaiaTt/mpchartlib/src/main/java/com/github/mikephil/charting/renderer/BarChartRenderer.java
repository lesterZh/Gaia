...
public class BarChartRenderer extends DataRenderer {
    ...
    protected RectF mBarRectR = new RectF();
    ...
    protected void drawDataSet(Canvas c, IBarDataSet dataSet, int index) {
        ...
        if (mChart.isDrawBarShadowEnabled()) {
            ...
            for (int j = 0; j < buffer.size(); j += 4) {
                ...
                mBarRectR.set(buffer.buffer[j], mViewPortHandler.contentTop()-30,
                        buffer.buffer[j + 2],
                        mViewPortHandler.contentBottom()-40);
                c.drawRoundRect(mBarRectR,30, 30, mShadowPaint);
            }
        }
        ...
        if (dataSet.getColors().size() > 1) {
            ...
            for (int j = 0; j < buffer.size(); j += 4) {
               ...
               /* c.drawRect(buffer.buffer[j], buffer.buffer[j + 1], buffer.buffer[j + 2],
                ...
                mBarRectR.set(buffer.buffer[j], buffer.buffer[j + 1]-30, buffer.buffer[j + 2],
                        buffer.buffer[j + 3]-40);
                c.drawRoundRect(mBarRectR,  30, 30, mRenderPaint);
                ...
                if (drawBorder) {
                    ...
                    mBarRectR.set(buffer.buffer[j], buffer.buffer[j + 1]-30, buffer.buffer[j + 2],
                            buffer.buffer[j + 3]-40);
                    c.drawRoundRect(mBarRectR, 30, 30, mBarBorderPaint);
                }
            }
        } else {
        ...
        for (Highlight high : indices) {
            ...
            for (int dataSetIndex = minDataSetIndex;
                ...
                if (index >= 0
                   ...
                   // c.drawRoundRect(mBarRect, 100, 100, mHighlightPaint);

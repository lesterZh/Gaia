...
public class BarData extends BarLineScatterCandleBubbleData<IBarDataSet> {
    ...
    public BarData(List<String> xVals,List<String> xValsDate) {
        super(xVals,xValsDate);
    }

    public BarData(String[] xVals,String[] xValsDate) {
        super(xVals,xValsDate);
    }

    public BarData(List<String> xVals,List<String> xValsDate, List<IBarDataSet> dataSets) {
        super(xVals,xValsDate, dataSets);
    }

    public BarData(String[] xVals,String[] xValsDate, List<IBarDataSet> dataSets) {
        super(xVals, xValsDate,dataSets);
    }

    public BarData(List<String> xVals,List<String> xValsDate, IBarDataSet dataSet) {
        super(xVals,xValsDate,  toList(dataSet));
    }

    public BarData(String[] xVals,String[] xValsDate, IBarDataSet dataSet) {
        super(xVals,xValsDate, toList(dataSet));
    }

...
public class XAxis extends AxisBase {
    ...
    protected List<String> mDateValues = new ArrayList<String>();

    public List<String> getmDateValues() {
        return mDateValues;
    }

    public void setmDateValues(List<String> mDateValues) {
        this.mDateValues = mDateValues;
    }

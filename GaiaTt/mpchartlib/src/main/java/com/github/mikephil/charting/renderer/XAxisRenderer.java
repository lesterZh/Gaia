...
public class XAxisRenderer extends AxisRenderer {
    ...
    public XAxisRenderer(ViewPortHandler viewPortHandler, XAxis xAxis, Transformer trans) {
        ...
        mAxisLabelDatePaint.setColor(Color.BLACK);
        mAxisLabelDatePaint.setTextAlign(Align.CENTER);
        mAxisLabelDatePaint.setTextSize(Utils.convertDpToPixel(10f));
    }
    ...
    public void computeAxisDate(float xValMaximumLength, List<String> xValues) {

        mAxisLabelDatePaint.setTypeface(mXAxis.getTypeface());
        mAxisLabelDatePaint.setTextSize(mXAxis.getTextSize());
        ...
        final FSize labelSize = Utils.calcTextSize(mAxisLabelDatePaint, widthText.toString());

        final float labelWidth = labelSize.width;
        final float labelHeight = Utils.calcTextHeight(mAxisLabelDatePaint, "Q");
        ...
        final FSize spaceSize = Utils.calcTextSize(mAxisLabelDatePaint, space.toString());
    ...
    public void renderAxisLabels(Canvas c) {
        ...
        mAxisLabelDatePaint.setTypeface(mXAxis.getTypeface());
        mAxisLabelDatePaint.setTextSize(mXAxis.getTextSize());
        mAxisLabelDatePaint.setColor(mXAxis.getTextColor());
    ...
    protected void drawLabels(Canvas c, float pos, PointF anchor) {
        ...
        for (int i = mMinX; i <= mMaxX; i += mXAxis.mAxisLabelModulus) {
            ...
            if (mViewPortHandler.isInBoundsX(position[0])) {
                ...
                String labelDate = mXAxis.getmDateValues().get(i);
                ...
                drawLabel(c, labelDate, i, position[0], pos+50, anchor, labelRotationAngleDegrees);
            }
        }
    }

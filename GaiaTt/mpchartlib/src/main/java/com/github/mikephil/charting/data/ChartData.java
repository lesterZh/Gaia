...
public abstract class ChartData<T extends IDataSet<? extends Entry>> {
    ...
    protected List<String> mXValsDate;

    public List<String> getmXValsDate() {
        return mXValsDate;
    }

    public void setmXValsDate(List<String> mXValsDate) {
        this.mXValsDate = mXValsDate;
    }
    ...
    public ChartData() {
        ...
        mXValsDate = new ArrayList<String>();
     ...
     * @param xVals
     */
    public ChartData(List<String> xVals,List<String> xValsDate) {
        this.mXVals = xVals;
        this.mXValsDate = mXValsDate;
     ...
     * @param xVals
     */
    public ChartData(String[] xVals,String[] xValsDate) {
        this.mXVals = arrayToList(xVals);
        this.mXValsDate = arrayToList(xValsDate);
        this.mDataSets = new ArrayList<T>();
        init();
    }
     ...
     */
    public ChartData(List<String> xVals, List<String> xValsDate,List<T> sets) {
        this.mXVals = xVals;
        this.mXValsDate = xValsDate;
        this.mDataSets = sets;
     ...
     * @param sets  the dataset array
     */
    public ChartData(String[] xVals,String[] xValsDate,List<T> sets) {
        this.mXVals = arrayToList(xVals);
        this.mXValsDate = arrayToList(xValsDate);
        this.mDataSets = sets;

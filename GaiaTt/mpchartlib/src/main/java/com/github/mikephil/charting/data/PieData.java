...
public class PieData extends ChartData<IPieDataSet> {
    ...
    public PieData(List<String> xVals,List<String> xValsDate) {
        super(xVals,xValsDate);
    }

    public PieData(String[] xVals,String[] xValsDate) {
        super(xVals,xValsDate);
    }

    public PieData(List<String> xVals, List<String> xValsDate,IPieDataSet dataSet) {
        super(xVals,xValsDate, toList(dataSet));
    }

    public PieData(String[] xVals,String[] xValsDate, IPieDataSet dataSet) {
        super(xVals, xValsDate, toList(dataSet));
    }

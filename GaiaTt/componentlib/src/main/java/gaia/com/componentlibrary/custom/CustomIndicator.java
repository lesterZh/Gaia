...
public class CustomIndicator extends LinearLayout{
    ...
    public void setIndicatorColor(int mColor) {
        this.mColor = getResources().getColor(mColor);
    }

    public void setUnSelectTextColor(int mUnselectTextColorId) {
        this.mUnselectTextColorId = getResources().getColor(mUnselectTextColorId);
        if(mViewPager!=null)
        updateTextColor();
    }

    public void setSelectTextColor(int mSelectTextColorId) {
        this.mSelectTextColorId = getResources().getColor(mSelectTextColorId);
        if(mViewPager!=null)
        updateTextColor();
    }
...
//        itemWidth = width / mChildCount;
    ...
    public void setTitles(List<String> titles){
        ...
        for(int i=0;i<mChildCount;i++){
            ...
            //text.setTextSize(mTitleTextSize);
    ...
    private void updateTextColor(){
        ...
        for(int i=0;i<map.size();i++){
            if(i==mViewPager.getCurrentItem()){
                map.get(i).setTextColor(mSelectTextColorId);
            }else{
                map.get(i).setTextColor(mUnselectTextColorId);
            }
        }
    }

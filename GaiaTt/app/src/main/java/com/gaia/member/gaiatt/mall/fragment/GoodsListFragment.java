 ...
 * Description: 商城主界面中的商品 fragment
 * @date 2016/6/7 12:03
 */
public class GoodsListFragment extends Fragment {
    ...
    class GoodsAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            final GoodsBean goodsBean = (GoodsBean) getItem(position);
            ...
            viewHolder.btnAddShoppingCart.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    UiUtils.showToast(mContext, "成功添加到购物车");
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    GoodsDetailActivity.actionStart(mContext, goodsBean);
                }
            });
            return convertView;
        }

 ...
 */
public class CustomDrinkPicker {
    Context mContext;
    ...
    public CustomDrinkPicker(Context context) {
        mContext = context;
        rootView = View.inflate(context, R.layout.layout_custom_drink_picker, null);
     ...
     * @param layout
     */
    public CustomDrinkPicker(Context context, int layout) {
        mContext = context;

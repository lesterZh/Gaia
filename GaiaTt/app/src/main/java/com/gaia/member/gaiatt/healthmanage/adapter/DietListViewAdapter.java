 ...
 * @author 移动开发组-王浩韩
 * @version V1.0
 * @Title: DietListViewAdapter
 * @Package com.gaia.member.gaiatt.healthmanage.adapter
 * @Description: 干预计划详情饮食记录列表适配器
...
public class DietListViewAdapter extends BaseAdapter {
    ...
    private ArrayList<DietListBean> datas;
    private LayoutInflater layoutInflater;

    public DietListViewAdapter(Context context, ArrayList<DietListBean> datas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.item_diet_listview_layout, parent, false);
            viewHolder = new ViewHolder(convertView);
            viewHolder.itemHealthlistBarLl = (LinearLayout) convertView.findViewById(R.id.item_healthlist_bar_ll);

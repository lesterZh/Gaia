...
public class WineFragment extends Fragment {
    ...
    @Bind(R.id.add_img)
    ImageView addImg;
    @Bind(R.id.tv_wine_number)
    TextView tvWineNumber;
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.wine_fragment, container, false);
    ...
    private void initBarChart() {
        ...
        MpChartUtils.setBarChartSet(getActivity(),barChart,
                ...
                getResources().getColor(R.color.drink_line_a),
                "ml",getActivity().getResources().getColor(R.color.drink_index_r));
        //添加睡眠时间
        addImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pickerDialogUtils.setDoublePickerDialog(getActivity(), GetResourcesUtils.getString(getActivity(), R
                                .string.drink_dialog_title), GetResourcesUtils.getString(getActivity(),R.string.drink_dialog_content1),
                        GetResourcesUtils.getString(getActivity(),R.string.drink_dialog_content2), LocalDataUtils.getDrinkTypeArrayList(getActivity()), LocalDataUtils.getDrinkNumArrayList(), 3,
                        new PickerDialogUtils.OnDialogClickListener() {
                                    @Override
                                    public void okDialogClick(String text1, String text2) {
                                        tvWineNumber.setText(text2+"ml");
                                    }
                                });
            }
        });
    ...
    private BarData getBarData(int count, int dataCount) {
        ...
        for (int i = 0; i < dataCount; i++) {
            ...
            mColor.add(getResources().getColor(R.color.drink_index_bar));
        }

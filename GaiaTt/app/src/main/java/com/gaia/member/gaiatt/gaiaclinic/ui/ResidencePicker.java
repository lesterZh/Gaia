...
import com.gaia.member.gaiatt.healthmanage.ui.WheelView;
...
public class ResidencePicker {
    ...
    public ResidencePicker(final Context context) {
        mContext = context;
        rootView = View.inflate(context, R.layout.layout_custom_picker, null);
        ...
        wheel1.setOnSelectListener(new WheelView.OnSelectListener() {
            ...
            public void endSelect(int id, final String text) {
                ...
                ((Activity)context).runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        setWheelDataIndex(2, ResidenceUtils.getCityData(text), 0);
                    }
                });
     ...
     * @param layout
     */
    public ResidencePicker(Context context, int layout) {
        mContext = context;

 ...
 */
public class CustomSportPicker {
    Context mContext;
    ...
    public CustomSportPicker(Context context) {
        mContext = context;
        rootView = View.inflate(context, R.layout.layout_custom_sport_picker, null);
     ...
     * @param layout
     */
    public CustomSportPicker(Context context, int layout) {
        mContext = context;

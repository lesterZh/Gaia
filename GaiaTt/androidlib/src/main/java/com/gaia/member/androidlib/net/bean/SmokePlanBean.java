...
/**
 * @ClassName: SmokePlanBean
 *Description: TODO
 *@author android移动客户端-王浩韩
 * @date 2016/6/13 14:00
 */
public class SmokePlanBean {
    /**
     ...
     * "attrs":[{"title":"上午","count":"0根"}],"count":0}],"title":"戒烟计划","detail":"减少对烟草依赖","noitce":"注意事项：xxxx",
     * "repeatDetail":"30天","fitGroupDetail":"适用年龄20岁-30岁","levelDetail":"","startDate":"2015-02-03",
